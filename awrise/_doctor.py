...
interesting failures live BETWEEN them. "awrise is installed" is not the useful
fact -- "awrise is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWRISE_DECIDE_TOKEN', 'AWRISE_HOME']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awrise needs at runtime, and a
